...
def main():
    ...
    if args.output:
        ...
        np.savez(output_name,
            zvalues=zvalues,DH_hist=DH_hist,DA_hist=DA_hist,phi_hist=phi_hist,f_hist=f_hist,
            de_hist=de_hist,w_hist=w_hist,q_hist=q_hist,DH_realizations=DH_realizations,
            DH0=DH0,DA0=DA0,phi0=phi0,f0=f0,de0=de0,w0=w0,q0=q0,fixed_options=fixed_options,bin_range=bin_range,
